...
export const ICON_BY_NODE_TYPE = {
    ...
    [NodeType.Text]:(mimeType?: string) => mimeType === MIME_TYPE['application/pdf'] ? 'FilePdf' : 'FileText',
...
export const ICON_COLOR_BY_NODE_TYPE = {
    ...
    [NodeType.Text]: (theme?: DefaultTheme, mimeType?: string) => mimeType === MIME_TYPE['application/pdf'] ? (theme?.palette.error.regular ?? '#d74942') : (theme?.palette.primary.regular ?? '#2b73d2'),
